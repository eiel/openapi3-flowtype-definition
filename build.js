const { parseSchema, simplifySchema, convertSchema,schemaToFlow } = require('json-schema-to-flow-type')
const axios = require('axios')

const OpenAPISchemaURL = 'https://raw.githubusercontent.com/timburks/OpenAPI-Specification/5f3a9a7f547785c3f38001fc0ef82ff621d1bb79/schemas/v3.0/schema.json'
...
const getOpenAPISchema = () => axios.get(OpenAPISchemaURL).then(({ data }) => data)
